...
class ChatBot:
    def __init__(self):
        ...
        self.model = genai.GenerativeModel(model_name='gemini-1.5-flash', system_instruction=["""Hello you are Holly, an AI Travel Assistant. You start with something like "I'm here to help you plan the perfect trip.
            ...
            It's important to retrieve from user the questions mentioned above and add some additional questions according to user prefrences. Try to be a bit funny to keep user engagement.
            """])
        self.chat = None
        self.configure()
